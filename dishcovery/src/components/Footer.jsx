      ...
      <Container>
        <Row className="text-center text-md-start">
          ...
          <Col md={4} className="mb-3 mb-md-0">
            ...
            <ul className="list-unstyled">
              <li><a href="/feed" className="text-dark">Recipes</a></li>
              <li><a href="/" className="text-dark">Fitness</a></li>
              <li><a href="/" className="text-dark">Healthy Living</a></li>
              <li><a href="/explore" className="text-dark">Blogs</a></li>
            </ul>
          </Col>
        </Row>
